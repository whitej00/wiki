...
- **Type of Service (TOS)** (8비트): 서비스 유형 구분. 2비트는 **ECN**([[congestion-control|혼잡 제어]])에 사용
...
- 32비트, **인터페이스** 단위 할당
- [[ip-addressing|서브넷]], [[ip-addressing|CIDR]], [[ip-addressing|최장 프리픽스 매칭]] 참조
- 주소 획득: [[DHCP]]
- 사설 주소와 공인 주소 변환: [[NAT]]

## 관련 프로토콜

- **[[IPv6]]**: IPv4의 후속. 주소 고갈 문제 해결 (128비트)
- **[[DHCP]]**: IPv4 주소 자동 할당
- **[[NAT]]**: 사설 IP ↔ 공인 IP 변환
- **[[TCP]], [[UDP]]**: IPv4 데이터그램의 페이로드로 전송되는 상위 프로토콜
