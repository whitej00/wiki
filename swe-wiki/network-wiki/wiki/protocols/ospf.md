...
인터넷에서 가장 널리 사용되는 **intra-AS(자율 시스템 내부) 라우팅 프로토콜**. [[routing-algorithms|Link-State 알고리즘]](Dijkstra)을 기반으로 하며, IS-IS와 함께 intra-AS 라우팅의 양대 산맥이다.
