...
### 5.2 [[routing-algorithms|Routing Algorithms]]
...
- 현대 인터넷 라우팅([[OSPF]], [[BGP]])은 load-insensitive
...
- [[OSPF]]: LS 기반, Dijkstra, RFC 2328, IP 직접 전송(프로토콜 번호 89)
...
- CIDRized prefix 단위 목적지, [[TCP]] 포트 179 세미영구 연결
...
### 5.5 [[sdn-control-plane|SDN Control Plane]]
...
### 5.7 [[network-management|Network Management]] and SNMP, NETCONF/YANG
...
## 위키에 반영된 페이지
- [[routing-algorithms]] — LS/DV 알고리즘, 분류, 비교
- [[OSPF]] — Intra-AS 라우팅 프로토콜
- [[BGP]] — Inter-AS 라우팅 프로토콜
- [[sdn-control-plane]] — SDN 컨트롤러, OpenFlow
- [[ICMP]] — 에러 보고, traceroute
- [[network-management]] — SNMP/MIB, NETCONF/YANG
- [[layers/network]] — 네트워크 계층 (컨트롤 플레인 보강)
